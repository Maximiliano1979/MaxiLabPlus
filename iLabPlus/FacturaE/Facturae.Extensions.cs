...
using iLabPlus.FacturaE.DataType;
using System;
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Nemesis365.Facturae"/> class.
    /// </summary>
    public Facturae()
    {
...
public partial class InvoiceType
{
    ...
    private DoubleUpToEightDecimalType CalculateTaxOutputTotal()
    {
        ...
        //{
        //    double sum = 0.0;
        //    foreach (var to in TaxesOutputs)
        //    {
        //        double taxAmount = to.TaxAmount.TotalAmount;
        //        double equivalenceSurchargeAmount = 0.0;
        //        if (to.EquivalenceSurchargeAmount != null)
        //        {
        //            equivalenceSurchargeAmount = to.EquivalenceSurchargeAmount.TotalAmount;
        //        }
        //        sum += Math.Round(taxAmount, 2, MidpointRounding.AwayFromZero)  + Math.Round(equivalenceSurchargeAmount, 2, MidpointRounding.AwayFromZero) ;
        //    }
        //    result = Math.Round(sum, 2, MidpointRounding.AwayFromZero);
...
public partial class InvoiceLineType
{
    ...
    public InvoiceType CalculateTotals()
    {
        ...
        //xavi
        TotalCost = Math.Round(Quantity * UnitPriceWithoutTax, 2, MidpointRounding.AwayFromZero);
        ...
        (
            tax =>
            {
                ...
                // XAVI
                tax.TaxAmount.TotalAmount = (tax.TaxableBase.TotalAmount * tax.TaxRate / 100).Round(4);
