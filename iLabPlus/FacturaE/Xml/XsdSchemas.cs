...
namespace iLabPlus.FacturaE.Xml;
...
internal static class XsdSchemas
{
    ...
    private static readonly string s_XmlDsigSchemaResource  = "Nemesis365.FacturaE.Schemas.xmldsig-core-schema.xsd";
    private static readonly string s_FacturaeSchemaResource = "Nemesis365.FacturaE.Schemas.Facturaev3_2_2.xsd";
    ...
    internal static XmlNamespaceManager CreateXadesNamespaceManager(XmlNameTable nt)
    {
        ...
        nsmgr.AddNamespace(s_FacturaePrefix, s_FacturaeNamespaceUrl);
        nsmgr.AddNamespace(s_XmlDsigPrefix , s_XmlDsigNamespaceUrl);
    ...
    internal static XmlElement FixupNamespaces(XmlDocument envDoc, XmlElement inputElement)
    {
        ...
        var nsmgr = CreateXadesNamespaceManager(doc);

        doc.LoadXml(inputElement.OuterXml);

        if (envDoc is not null)
        {
    ...
    private static XmlSchema ReadSchema(string resourceName)
    {
        ...
        //var xxx = XmlSchema.Read(currentAssembly.GetManifestResourceStream(resourceName), SchemaSetValidationEventHandler);
